...
ros::Publisher wrench_pub_RLeg,wrench_pub_LLeg;
...
Sensor::Sensor(){
    ...
    joint_state_sub = n.subscribe("/bipedv5/joint_states", 10, &Sensor::joint_stateCb,this); //this为回调函数所处的类，即当前类
    model_state_sub = n.subscribe("/gazebo/model_states", 10, &Sensor::model_stateCb,this);
    link_state_sub = n.subscribe("/gazebo/link_states", 10, &Sensor::link_stateCb,this);
...
{   
    ...
    lmtz = MediatorNew(10);
    rmtz = MediatorNew(10);
    message_filters::Subscriber<gazebo_msgs::ContactsState> left_contact_sub(nh,"/bipedv5/left_contact", 10);
    message_filters::Subscriber<gazebo_msgs::ContactsState> right_contact_sub(nh,"/bipedv5/right_contact", 10);
    ...
    wrench_pub_LLeg = nh.advertise<geometry_msgs::WrenchStamped>("/bipedv5/LLeg/force_torque_states", 50);
    wrench_pub_RLeg = nh.advertise<geometry_msgs::WrenchStamped>("/bipedv5/RLeg/force_torque_states", 50);
    while(ros::ok()){
